...
image = (
    ...
    .add_local_file("New Visuals/Figure_1.png", "/root/assets/Figure_1.png")
    ...
    .add_local_file("New Visuals/semantic_drift_yr_to_yr.png", "/root/assets/semantic_drift_yr_to_yr.png")
)
